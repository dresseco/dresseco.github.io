  ...
  <div class="container-fluid">
    ...
    <div id="dresseco-header-navbar-action-buttons" class="order-lg-1">
      <div id="dresseco-header-navbar-action-buttons-main">
        <div id="dresseco-header-navbar-action-buttons-main-language" class="btn-group">
        <button
        ...
        <div
        id="dresseco-header-navbar-action-buttons-main-language-dropdown"
        class="dropdown-menu"
      >
        ...
        >
          ...
          ><span id="cart-product-count-label"></span>
        </button>
        <button
